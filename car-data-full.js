...
const carDatabase = {
    ...
    "Lamborghini藍寶堅尼": {
        models: [
            ...
            // ========== Gallardo 系列 (經典) ==========
            { name: "Gallardo LP550-2", basePrice: 12000000, depreciation: 0.15 },
            { name: "Gallardo LP560-4", basePrice: 13000000, depreciation: 0.15 },
            { name: "Gallardo LP570-4", basePrice: 14500000, depreciation: 0.15 },
            { name: "Gallardo LP570-4 Superleggera", basePrice: 16000000, depreciation: 0.14 },
            { name: "Gallardo LP570-4 Performante", basePrice: 15500000, depreciation: 0.14 },
            { name: "Gallardo Spyder", basePrice: 14000000, depreciation: 0.15 },
            // ========== Huracan 系列 ==========
            { name: "Huracan LP580-2", basePrice: 14000000, depreciation: 0.15 },
            { name: "Huracan LP610-4", basePrice: 16000000, depreciation: 0.15 },
            { name: "Huracan LP640-4 Performante", basePrice: 18500000, depreciation: 0.14 },
            { name: "Huracan Evo RWD", basePrice: 17500000, depreciation: 0.14 },
            { name: "Huracan Evo Spyder", basePrice: 20000000, depreciation: 0.14 },
            { name: "Huracan STO", basePrice: 22000000, depreciation: 0.13 },
            { name: "Huracan Tecnica", basePrice: 19500000, depreciation: 0.14 },
            { name: "Huracan Sterrato", basePrice: 21000000, depreciation: 0.13 },
            // ========== Aventador 系列 ==========
            { name: "Aventador LP700-4", basePrice: 24000000, depreciation: 0.14 },
            { name: "Aventador LP700-4 Roadster", basePrice: 26000000, depreciation: 0.14 },
            { name: "Aventador LP720-4", basePrice: 27000000, depreciation: 0.14 },
            { name: "Aventador LP750-4 SV", basePrice: 32000000, depreciation: 0.13 },
            { name: "Aventador S", basePrice: 28000000, depreciation: 0.14 },
            { name: "Aventador S Roadster", basePrice: 30000000, depreciation: 0.14 },
            { name: "Aventador SVJ", basePrice: 38000000, depreciation: 0.12 },
            { name: "Aventador SVJ Roadster", basePrice: 42000000, depreciation: 0.12 },
            { name: "Aventador Ultimae", basePrice: 45000000, depreciation: 0.12 },
            { name: "Aventador Ultimae Roadster", basePrice: 48000000, depreciation: 0.12 },
            // ========== Urus 系列 ==========
            { name: "Urus S", basePrice: 12000000, depreciation: 0.15 },
            { name: "Urus Performante", basePrice: 14500000, depreciation: 0.14 },
            { name: "Urus SE", basePrice: 13500000, depreciation: 0.15 },
            // ========== 限量/特別版 ==========
            { name: "Sian", basePrice: 120000000, depreciation: 0.10 },
            { name: "Countach LPI 800-4", basePrice: 95000000, depreciation: 0.10 },
            { name: "Veneno", basePrice: 150000000, depreciation: 0.08 },
            { name: "Centenario", basePrice: 85000000, depreciation: 0.10 }
        ]
    },
    ...
    "Land Rover路虎": {
        models: [
            ...
            // ========== Defender 系列 ==========
            { name: "Defender 90", basePrice: 2800000, depreciation: 0.16 },
            { name: "Defender 90 S", basePrice: 3000000, depreciation: 0.16 },
            { name: "Defender 90 SE", basePrice: 3200000, depreciation: 0.16 },
            { name: "Defender 90 HSE", basePrice: 3500000, depreciation: 0.16 },
            { name: "Defender 90 X", basePrice: 4000000, depreciation: 0.15 },
            { name: "Defender 90 V8", basePrice: 5500000, depreciation: 0.14 },
            { name: "Defender 110", basePrice: 3200000, depreciation: 0.16 },
            { name: "Defender 110 S", basePrice: 3400000, depreciation: 0.16 },
            { name: "Defender 110 SE", basePrice: 3600000, depreciation: 0.16 },
            { name: "Defender 110 HSE", basePrice: 3900000, depreciation: 0.16 },
            { name: "Defender 110 X", basePrice: 4500000, depreciation: 0.15 },
            { name: "Defender 110 V8", basePrice: 6000000, depreciation: 0.14 },
            { name: "Defender 130", basePrice: 4000000, depreciation: 0.16 },
            { name: "Defender 130 SE", basePrice: 4300000, depreciation: 0.16 },
            { name: "Defender 130 HSE", basePrice: 4600000, depreciation: 0.15 },
            { name: "Defender 130 X", basePrice: 5200000, depreciation: 0.15 },
            // ========== Discovery 系列 ==========
            { name: "Discovery 3", basePrice: 1500000, depreciation: 0.17 },
            { name: "Discovery 4", basePrice: 2200000, depreciation: 0.17 },
            { name: "Discovery 5", basePrice: 3600000, depreciation: 0.16 },
            { name: "Discovery S", basePrice: 3400000, depreciation: 0.16 },
            { name: "Discovery SE", basePrice: 3700000, depreciation: 0.16 },
            { name: "Discovery HSE", basePrice: 4200000, depreciation: 0.16 },
            { name: "Discovery HSE Luxury", basePrice: 4600000, depreciation: 0.15 },
            { name: "Discovery Sport S", basePrice: 2300000, depreciation: 0.17 },
            { name: "Discovery Sport SE", basePrice: 2500000, depreciation: 0.17 },
            { name: "Discovery Sport HSE", basePrice: 2800000, depreciation: 0.16 },
            { name: "Discovery Sport R-Dynamic", basePrice: 2700000, depreciation: 0.16 },
            // ========== Range Rover 系列 ==========
            { name: "Range Rover SE", basePrice: 6500000, depreciation: 0.15 },
            { name: "Range Rover HSE", basePrice: 7500000, depreciation: 0.15 },
            { name: "Range Rover Autobiography", basePrice: 9000000, depreciation: 0.14 },
            { name: "Range Rover SV", basePrice: 12000000, depreciation: 0.14 },
            { name: "Range Rover SVAutobiography", basePrice: 11000000, depreciation: 0.14 },
            { name: "Range Rover LWB", basePrice: 8500000, depreciation: 0.15 },
            { name: "Range Rover P400", basePrice: 7200000, depreciation: 0.15 },
            { name: "Range Rover P530", basePrice: 8800000, depreciation: 0.15 },
            { name: "Range Rover D350", basePrice: 7800000, depreciation: 0.15 },
            { name: "Range Rover PHEV", basePrice: 8500000, depreciation: 0.15 },
            // ========== Range Rover Sport 系列 ==========
            { name: "Range Rover Sport SE", basePrice: 4500000, depreciation: 0.15 },
            { name: "Range Rover Sport HSE", basePrice: 5200000, depreciation: 0.15 },
            { name: "Range Rover Sport HST", basePrice: 5800000, depreciation: 0.15 },
            { name: "Range Rover Sport Autobiography", basePrice: 6500000, depreciation: 0.15 },
            { name: "Range Rover Sport SVR", basePrice: 8500000, depreciation: 0.14 },
            { name: "Range Rover Sport P400", basePrice: 5500000, depreciation: 0.15 },
            { name: "Range Rover Sport P530", basePrice: 7000000, depreciation: 0.15 },
            { name: "Range Rover Sport PHEV", basePrice: 6000000, depreciation: 0.15 },
            // ========== Range Rover Evoque 系列 ==========
            { name: "Range Rover Evoque S", basePrice: 2200000, depreciation: 0.17 },
            { name: "Range Rover Evoque SE", basePrice: 2400000, depreciation: 0.17 },
            { name: "Range Rover Evoque HSE", basePrice: 2700000, depreciation: 0.16 },
            { name: "Range Rover Evoque R-Dynamic", basePrice: 2600000, depreciation: 0.16 },
            { name: "Range Rover Evoque Autobiography", basePrice: 3000000, depreciation: 0.16 },
            { name: "Range Rover Evoque Convertible", basePrice: 3200000, depreciation: 0.16 },
            // ========== Range Rover Velar 系列 ==========
            { name: "Range Rover Velar S", basePrice: 3200000, depreciation: 0.16 },
            { name: "Range Rover Velar SE", basePrice: 3500000, depreciation: 0.16 },
            { name: "Range Rover Velar HSE", basePrice: 3900000, depreciation: 0.16 },
            { name: "Range Rover Velar R-Dynamic", basePrice: 3800000, depreciation: 0.16 },
            { name: "Range Rover Velar SVAutobiography", basePrice: 5500000, depreciation: 0.15 },
            { name: "Range Rover Velar P400", basePrice: 4200000, depreciation: 0.16 },
            // ========== Freelander 系列 (經典) ==========
            { name: "Freelander 2", basePrice: 1200000, depreciation: 0.18 },
            { name: "Freelander 2 HSE", basePrice: 1400000, depreciation: 0.18 }
        ]
    },
